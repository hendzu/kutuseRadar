...
- [ ] [B16 — GET /api/memberships (membership options by chain)](../backend/done/B16-membership-options.md)
- [ ] [B17 — POST /api/memberships/user (add membership)](../backend/done/B17-membership-add.md)
- [ ] [B18 — PUT /api/memberships/user (update membership)](../backend/done/B18-membership-update.md)
- [ ] [B19 — DELETE /api/memberships/user (delete membership)](../backend/done/B19-membership-delete.md)
